...
export function validateRegistrationForm(form) {
  ...
  if (logo && !acceptedLogoTypes.has(logo.type)) {
    return "Logoja duhet të jetë skedar JPG, PNG ose WebP.";
  }

  if (logo && logo.size > maximumLogoBytes) {
    return "Logoja nuk duhet të jetë më e madhe se 2 MB.";
  }
